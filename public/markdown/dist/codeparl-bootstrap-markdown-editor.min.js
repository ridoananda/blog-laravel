...
{},b.fn.codeparlMarkdown.defaults,c),l=this.parent(),k=b("<div>").addClass("cpme-preview markdown-body overflow-auto p-2 bg-white border").appendTo(l).css({height:c.editorHeight+"px",width:c.editorWidth}),0<a.trim().length&&(a=r.makeHtml(a||""),this.html(k.html(v(a))),Prism.highlightAllUnder(k[0])))},destroy:function(){}};b.fn.codeparlMarkdown=function(a){if(y[a])return y[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"!==b.type(a)&&a)b.error("The method "+a+" does not exist on codeparlMarkdown");
else return y.init.apply(this,arguments)};b.fn.codeparlMarkdown.defaults={fullscreen:!0,content:{allowScript:!1,image:{types:".jpeg,.jpg,.png,.gif",placeholder:"../src/photo-placeholder.jpg",backendScript:""}},help:{show:!0,link:{url:"https://www.markdownguide.org/basic-syntax/",text:"Advanced help"}},editor:{softTabs:!0,theme:"tomorrow",editorHeight:500,fontSizes:{Small:12,Normal:16,Large:18,Xlarge:26},defaultFont:"Normal",showGutter:!1},toolbar:{bg:"#F7F7F4",buttonGroups:[{btnHeader1:"H1",btnHeader2:"H2"},
{btnBold:"fa-bold",btnItalic:"fa-italic"},{btnList:"fa-list-ul",btnOrderedList:"fa-list-ol",btnRule:"line"},{btnBlock:"fa-quote-left",btnCode:"{ }"},{btnLink:"fa-link"},{btnImage:"fa-image"},{btnFont:"font-size"},{btnEdit:"fa-edit",btnbrowse:"fa-folder-open",btnPreview:"fa-eye",btnFullscreen:"fa-expand"},{btnHelp:"fa-question-circle"}]},onFileBrowse:function(a,c){if(a[0].files[0]){var e=new FileReader;e.onload=function(g){c.session.setValue(g.target.result);c.clearSelection()};e.readAsText(a[0].files[0])}},
onPreview:function(a,c){}}})(jQuery,window);